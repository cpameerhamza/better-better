...
import { closeEye, envelopIcon, openEye } from "../../utils/SvgIcons";
        ...
        <div className="left__form">
          <div className="left__form-inner">
            ...
            <form
              ...
              className="login__form d__flex d__flex-h-between gap-2"
            >
              <div className="form__group full__field">
                ...
                <input
                  ...
                  onBlur={handleBlur}
                />
                <span className="hideShowPassword">{envelopIcon()}</span>
