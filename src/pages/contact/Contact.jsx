                ...
                <div className="site__container">
                    <div className="landing__header-content d__flex d__flex-h-between d__flex-v-center">
                        <div className="landing__header-logo">
                            <NavLink to="/"><img src={Logo} alt="Better Letter" /></NavLink>
                        </div>
                ...
                <div className="contact-cols">
                    ...
                    <form className="form" onSubmit={handleSubmit}>
                        ...
                        <div className="form-row">
                            ...
                            />
                            <p className="error-msg">{errors.contact_number && touched.contact_number ? errors.contact_number : null}</p>
                        </div>
                        <div className="form-row">
                            ...
                            />
                            <p className="error-msg">{errors.message && touched.message ? errors.message : null}</p>
                        </div>
                        <div className="form-row btn">
                            <button type="submit" className={`signup-btn ${loading || success ? "disabled" : ""}`}>
