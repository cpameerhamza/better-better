                ...
                <form onSubmit={handleSubmit}  className="registration-process-steps">
                        <div className="signup__form" >
                            ...
                            <div className="form__box">
                                ...
                                />
                                <p className="error-msg">{errors.current_state && touched.current_state ? errors.current_state : null}</p>
                                ...
                                {isOpen &&
                                    <div className="form__box-select">
                                        <Select
                                            ...
                                            // placeholder={"Search"}
                                            // menuIsOpen
                                            // options={states ? states : "No records found."}
                                        ...
                                        isMulti={false}
                                        options={states}
                                        className="search__select basic-multi-select"
                                        hideSelectedOptions={false}
                                ...
                                {/* <div className="form__group full__field">
                                    ...
                                    <Select
                                        ...
                                        hideSelectedOptions={false}
                                        onChange={(e) => setFieldValue("current_state", e.value) }
                                    />
                                    <input
                                        type="text"
                                        name="state_id"
