...
import {sentLettersCount, receivedLettersCount, pendingLettersCount, getTotalPenpals} from "../../redux/thunks/Thunks";
                ...
                <div className="main__body">
                    ...
                    <div className="main__body-content" ref={scroller}>
                        <div className="cards__box student__cards-box d__flex d__flex-h-between gap-2">
                            ...
                            {
                                user?.role_type === 1 ?
                                    <Card title="Penpal Letters Received" number={receivedLettersCounter} />
                                : ""
                            }
                            {
                                user?.role_type === 2 ?
                                    <Card title="Pending Penpal Requests" number={pendingLettersCounter} />
                                : ""
                            }
                        </div>
