...
export const registerUser = createAsyncThunk(
  ...
  async (payload) => {
    ...
    payload?.role_type === "1" &&
      formData.append("teacher_name", payload?.institute_contact_name);
    payload?.role_type === "1" &&
      formData.append("teacher_phone", payload?.institute_contact_number);
    payload?.role_type === "1" &&
      formData.append("teacher_email", payload?.institute_contact_email);

    payload?.role_type === "2" &&
      formData.append(
        "institute_contact_name",
        payload?.institute_contact_name
      );
    payload?.role_type === "2" &&
      formData.append(
        "institute_contact_number",
        payload?.institute_contact_number
      );
    payload?.role_type === "2" &&
      formData.append(
        "institute_contact_email",
        payload?.institute_contact_email
      );
    ...
    formData.append(
      "is_outside_united_states",
      payload.is_outside_united_states
    );
    ...
    formData.append(
      ...
      JSON.stringify(payload.musical_instrument_ids)
    );
...
export const resendVerifcationEmail = createAsyncThunk(
  "/resend-verification-email",
  async (payload) => {
    const formData = new FormData();
    formData.append("email", payload.email);
    const res = await api.post(`/resend-verification-email`, formData);
    return res;
  }
);
...
export const updateProfile = createAsyncThunk(
  ...
  async (payload) => {
    ...
    payload.values.role_type === 2 &&
      formData.append("avatar", payload.values.avatar);
    payload.values.role_type === 2 &&
      formData.append("last_name", payload.values.last_name);
    payload.values.role_type === 2 &&
      formData.append("about", payload.values.about);
...
export const sentLettersCount = createAsyncThunk(
  "/sent-letters-count",
  async (payload) => {
...
export const receivedLettersCount = createAsyncThunk(
...
export const pendingLettersCount = createAsyncThunk(
...
export const getTotalPenpals = createAsyncThunk(
  "/total-pen-pals",
  async (payload) => {
...
export const getPenpalRequests = createAsyncThunk(
  "/all-requests",
  async (payload) => {
...
export const manageRequest = createAsyncThunk(
  "/manage-request",
  async (payload) => {
    const formData = new FormData();
...
export const getElderDetails = createAsyncThunk(
  "/elder-details",
  async (payload) => {
...
export const getAllElders = createAsyncThunk(
  "/get-all-elders",
  async (payload) => {
...
export const userPenpalHistory = createAsyncThunk(
  "/user-penpal-history",
  async (payload) => {
    const formData = new FormData();
    formData.append("token", payload?.token);
...
export const getSinglePenpalHistory = createAsyncThunk(
  "/single-pen-pal-history",
  async (payload) => {
    const formData = new FormData();
    payload?.user.role_type === 1
      ? formData.append("elder_id", payload?.penpal_id)
      : formData.append("student_id", payload?.penpal_id);
    formData.append("token", payload?.token);
...
export const disconnectPenpal = createAsyncThunk(
  "/disconnect-penpal",
  async (payload) => {
    const formData = new FormData();
    user?.role_type === 1
      ? formData.append("elder_id", payload?.disconnecting_id)
      : formData.append("student_id", payload?.disconnecting_id);
    formData.append("token", payload?.token);
...
export const markNoticesAsRead = createAsyncThunk(
...
// Institute APIs
export const getLettersHistory = createAsyncThunk(
  "/institute-letters-history",
  async (payload) => {
    const formData = new FormData();
    formData.append("token", payload?.token);
    payload?.search && formData.append("search", payload?.search);
    const res = await api.post(
      payload?.pageLink ? payload?.pageLink : `/letters-history`,
      formData,
      {
        headers: {
          Authorization: `Bearer ${payload?.token}`,
...
export const markLetterReceived = createAsyncThunk(
...
export const registeredOnPenpals = createAsyncThunk(
  "/registered-on-penpal",
  async (payload) => {
    const formData = new FormData();
    formData.append("token", payload?.token);
...
export const lettersSentCount = createAsyncThunk(
  "/letters-sent-count",
  async (payload) => {
    const formData = new FormData();
    formData.append("token", payload?.token);
...
export const lettersReceivedCount = createAsyncThunk(
  "/letters-received-count",
  async (payload) => {
    const formData = new FormData();
    formData.append("token", payload?.token);
...
export const getStudentsHistory = createAsyncThunk(
  "/get-students-penpal-history",
  async (payload) => {
    const formData = new FormData();
    formData.append("token", payload?.token);
    payload?.search && formData.append("search", payload?.search);
    ...
    payload?.registration_date &&
      formData.append("registration_date", payload?.date);
    payload?.status && formData.append("status", payload?.status);

    const res = await api.post(
      payload?.pageLink ? payload?.pageLink : `/institute-get-penpals`,
      formData,
      {
        headers: {
          Authorization: `Bearer ${payload?.token}`,
...
export const singleStudentHistory = createAsyncThunk(
  "/single-user-pen-pal-history",
  async (payload) => {
    const formData = new FormData();
    formData.append("token", payload?.token);
